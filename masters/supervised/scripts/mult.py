...
# Data processing #
###################
_,control = read_zip('data/ControlMult_84N.zip')
time,learn = read_zip('data/Mult.zip')
baseline = 1
...
if not use_sub:
    ...
    pylab.axes([0.0+h_pad, 0.5+bottom_pad, 0.33-h_pad, 0.5-v_pad])
